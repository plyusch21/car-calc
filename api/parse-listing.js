...
Главное правило: заполняй поле, только если ты уверенно прочитал значение и понял, к чему оно относится. Сомневаешься, не разобрал, не уверен — оставь пустым. Пустое поле лучше угаданного: эти данные идут в расчёт стоимости автомобиля.
