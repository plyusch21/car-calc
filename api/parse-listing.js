 ...
 *
 * Почему Gemini: у него есть по-настоящему бесплатный тариф и нативный режим
 * строгого JSON-вывода по схеме (responseSchema) — не нужно самому парсить
 * произвольный текстовый ответ модели и гадать, не сломался ли формат. Модель
 * хорошо работает с многоязычным текстом (важно для китайских объявлений).
 *
